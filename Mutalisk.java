...
public class Mutalisk {
    ...
    public Mutalisk(int x, int y) {
        ...
        if (rotation <= 90) {
            Image image = new Image(getClass().getResource("assets/sprites/mutalisk-starcraft.gif").toExternalForm());
            this.sprite = new ImageView(image);
        } else {
            Image image = new Image(getClass().getResource("assets/sprites/mutalisk-starcraft2.gif").toExternalForm());
            this.sprite = new ImageView(image);
        }
